...
| `schedule-task.ps1`            | Preview, register, inspect, or remove optional Windows Task Scheduler task for periodic or startup controller execution                                                                                    | Windows Task Scheduler registration only with `-Action Register -Apply`; removable with `-Action Unregister -Apply`                                            |
