...
Write-Host ("AgentRouter serves: Manual Claude Code business/solution analysis; the Claude and Codex fallback route")
Write-Host ("9Router serves:     Unattended AO sessions (.claude-9router profile), Gemini, dsh")
