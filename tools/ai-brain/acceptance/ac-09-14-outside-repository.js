'use strict';
// AC-AI-09-14 — every negative proof of TASK-AI-09 must fail operationally
...
const SUBJECTS = [
  {
    script: 'ac-09-02-status-divergence.js',
    missing: 'docs/product-spec/work-items/TASK-AI-09.md',
  },
  {
    script: 'ac-09-04-dependency-unproven.js',
    missing: 'docs/product-spec/docs/10-ai-collaboration/FEATURE-DELIVERY-REGISTER.csv',
  },
  {
    script: 'ac-09-06-recovery-contract-broken.js',
    missing: 'scripts/ai/control.ps1',
  },
];
...
const outside = fs.mkdtempSync(path.join(os.tmpdir(), 'shipde-ac09-14-outside-'));
try {
  for (const subject of SUBJECTS) {
    let child;
    try {
