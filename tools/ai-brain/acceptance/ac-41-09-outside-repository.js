'use strict';
// AC-AI-41-09 — the four negative proofs must fail operationally (exit 2), not
...
// `./lib/review-grade.js` or `./lib/spec-status-alignment.js` or
...
const SUBJECTS = [
  'ac-41-02-status-divergence.js',
  'ac-41-04-dependency-unproven.js',
  'ac-41-06-review-default-raised.js',
  'ac-41-08-review-grade-out-of-ladder.js',
...
const outside = fs.mkdtempSync(path.join(os.tmpdir(), 'shipde-ac-41-09-outside-'));
let failures = 0;
try {
  for (const subject of SUBJECTS) {
