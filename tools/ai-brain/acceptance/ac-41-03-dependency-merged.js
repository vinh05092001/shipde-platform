'use strict';
// AC-AI-41-03 — the invariant: TASK-AI-41's register row declares exactly one
// dependency (TASK-AI-27) and that dependency is really merged into `origin/main`.
//
// The rule lives in `./lib/dependency-merged.js`, the same module the negative
// proof `ac-41-04-dependency-unproven.js` requires. The register is read from
// disk and Git supplies the merge evidence. Run outside the repository it exits
// 2, so it cannot pass where nothing exists.
//
// This row exists because the register records TASK-AI-41 as
// `BLOCKED_DEPENDENCY` while TASK-AI-27 is already merged in Git reality: the
...
const WORK_ITEM = 'TASK-AI-41';
const EXPECTED_DEPENDENCY = 'TASK-AI-27';
