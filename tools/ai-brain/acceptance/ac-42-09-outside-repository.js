'use strict';
// AC-AI-42-09 — the four negative proofs must fail operationally (exit 2), not
...
const SUBJECTS = [
  'ac-42-02-status-divergence.js',
  'ac-42-04-dependency-unproven.js',
  'ac-42-06-unvetted-setting-rejected.js',
  'ac-42-08-invalid-decision-refused.js',
...
const outside = fs.mkdtempSync(path.join(os.tmpdir(), 'shipde-ac-42-09-outside-'));
let failures = 0;
try {
  for (const subject of SUBJECTS) {
