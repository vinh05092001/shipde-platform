'use strict';
// AC-AI-27-03 — the invariant: TASK-AI-27's register row declares exactly one
...
// proof `ac-27-04-dependency-unproven.js` requires. The register is read from
// disk and Git supplies the merge evidence. Run outside the repository it exits
// 2, so it cannot pass where nothing exists.
//
// This row exists because the register records TASK-AI-27 as
