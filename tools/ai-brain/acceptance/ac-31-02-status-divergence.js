'use strict';
// AC-AI-31-02 - negative proof for the Control-table/register comparison.
//
// The check lives in `./lib/spec-status-alignment.js` and this script calls the
// SAME aggregate function the invariant `ac-31-01-status-alignment.js` calls
...
// is itself measured by `ac-31-09-outside-repository.js`.
const fs = require('fs');
const os = require('os');
...
const SPEC = 'docs/product-spec/work-items/TASK-AI-31.md';
...
const tmp = path.join(os.tmpdir(), 'shipde-ac31-02-' + process.pid + '.md');
