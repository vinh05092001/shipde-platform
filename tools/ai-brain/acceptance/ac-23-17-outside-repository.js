'use strict';
// AC-AI-23-17 — every negative proof of TASK-AI-23 must fail operationally
...
const SUBJECTS = [
  {
    script: 'ac-23-02-status-divergence.js',
    missing: 'docs/product-spec/work-items/TASK-AI-23.md',
  },
  {
    script: 'ac-23-04-retrieval-leak.js',
    missing: 'tools/ai-brain/lessons/lesson-seed.json',
  },
  {
    script: 'ac-23-06-retrieval-requirement-missing.js',
    missing: 'tools/ai-brain/lessons/lesson-seed.json',
  },
  {
    script: 'ac-23-10-dependency-unproven.js',
...
const outside = fs.mkdtempSync(path.join(os.tmpdir(), 'shipde-ac23-17-outside-'));
try {
  for (const subject of SUBJECTS) {
    let child;
    try {
