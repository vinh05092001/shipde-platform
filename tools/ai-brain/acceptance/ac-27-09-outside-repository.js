'use strict';
// AC-AI-27-09 — the four negative proofs must fail operationally (exit 2), not
...
// `./lib/coding-grade.js` or `./lib/spec-status-alignment.js` or
...
const SUBJECTS = [
  'ac-27-02-status-divergence.js',
  'ac-27-04-dependency-unproven.js',
  'ac-27-06-grade-default-raised.js',
  'ac-27-08-grade-out-of-ladder.js',
...
const outside = fs.mkdtempSync(path.join(os.tmpdir(), 'shipde-ac-27-09-outside-'));
let failures = 0;
try {
  for (const subject of SUBJECTS) {
