'use strict';
// AC-AI-42-04 — negative proof that an unmerged dependency is rejected.
//
// The rule lives in `./lib/dependency-merged.js`, the same module
// `ac-42-03-dependency-merged.js` requires. A copy of the register is written
// to `os.tmpdir()` with the dependency cell of TASK-AI-42 set to an unmerged
...
const tmp = path.join(os.tmpdir(), 'shipde-ac42-04-' + process.pid + '.csv');
