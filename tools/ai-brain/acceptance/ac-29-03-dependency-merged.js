'use strict';
// AC-AI-29-03 — the invariant: TASK-AI-29's register row declares exactly one
...
// proof `ac-29-04-dependency-unproven.js` requires. The register is read from
// disk and Git supplies the merge evidence. Run outside the repository it exits
// 2, so it cannot pass where nothing exists.
//
// This row exists because the register records TASK-AI-29 as
// `BLOCKED_DEPENDENCY` while TASK-AI-26 is already merged in Git reality: the
...
const EXPECTED_DEPENDENCY = 'TASK-AI-26';
