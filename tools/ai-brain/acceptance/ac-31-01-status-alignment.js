'use strict';
// AC-AI-31-01 — the invariant: TASK-AI-31's Control table and its
// delivery-register row (row 164) carry the same status. The comparison lives
// in `./lib/spec-status-alignment.js`, the same module the negative proof
// `ac-31-02-status-divergence.js` requires, so the gate and the proof of the
...
console.log('CONTROL_ALIGNED: ' + WORK_ITEM + ' ' + controlStatus(specText) + ' order 164');
process.exit(0);
