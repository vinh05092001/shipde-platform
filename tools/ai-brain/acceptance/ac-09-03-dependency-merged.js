'use strict';
// AC-AI-09-03 — the invariant: TASK-AI-09's register row declares exactly one
...
// proof `ac-09-04-dependency-unproven.js` requires and the module TASK-AI-08's
// pair `ac-08-03`/`ac-08-04` already requires. The register is read from disk and
// Git supplies the merge evidence. Run outside the repository it exits 2, so it
// cannot pass where nothing exists.
//
// This row exists because the register records TASK-AI-09 as
// `BLOCKED_DEPENDENCY` while TASK-AI-08 is already merged in Git reality at
// `8d039256adfa36172c09464123fcc9b488ab7f61` (PR #64): the dependency is proven
// here from the repository, not from a register status the reconciler has not yet
// rewritten.
const fs = require('fs');
...
const EXPECTED_DEPENDENCY = 'TASK-AI-08';
