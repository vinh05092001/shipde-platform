'use strict';
// AC-AI-29-02 — negative proof for the Control-table/register comparison.
//
// The comparison lives in `./lib/spec-status-alignment.js`, the same module the
// invariant `ac-29-01-status-alignment.js` requires. This script reads the REAL
...
const SPEC = 'docs/product-spec/work-items/TASK-AI-29.md';
...
const tmp = path.join(os.tmpdir(), 'shipde-ac29-02-' + process.pid + '.md');
