'use strict';
// AC-AI-24-10 — negative proof that the dependency rule refuses a dependency
// with no merge commit, having first proved the real row is accepted.
//
// The rule is `./lib/dependency-merged.js`, the same module
// `ac-24-09-dependency-merged.js` requires: editing the rule changes both the
...
const tmp = path.join(os.tmpdir(), 'shipde-ac24-10-' + process.pid + '.csv');
