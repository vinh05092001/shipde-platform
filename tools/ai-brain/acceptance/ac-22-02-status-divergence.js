'use strict';
// AC-AI-22-02 — negative proof for the Control-table/register comparison.
//
// The comparison lives in `./lib/spec-status-alignment.js`, the same module the
// invariant `ac-22-01-status-alignment.js` requires. This script reads the REAL
...
const tmp = path.join(os.tmpdir(), 'shipde-ac22-02-' + process.pid + '.md');
