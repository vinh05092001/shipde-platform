'use strict';
// AC-AI-29-09 — the four negative proofs must fail operationally (exit 2), not
...
const SUBJECTS = [
  'ac-29-02-status-divergence.js',
  'ac-29-04-dependency-unproven.js',
  'ac-29-06-entry-rule-refused.js',
  'ac-29-08-credential-in-registry.js',
...
const outside = fs.mkdtempSync(path.join(os.tmpdir(), 'shipde-ac-29-09-outside-'));
let failures = 0;
try {
  for (const subject of SUBJECTS) {
