'use strict';
// AC-AI-08-01 — the invariant: TASK-AI-08's Control table and its
// delivery-register row (row 141) carry the same status. The comparison lives
// in `./lib/spec-status-alignment.js`, the same module the negative proof
// `ac-08-02-status-divergence.js` requires, so the gate and the proof of the
...
console.log(
  'Control status matches register row 141: ' +
