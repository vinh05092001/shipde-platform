'use strict';
// AC-AI-32-08 — the three negative proofs must fail operationally (exit 2), not
...
const SUBJECTS = [
  'ac-32-02-status-divergence.js',
  'ac-32-04-dependency-unproven.js',
  'ac-32-06-mutation-rejected.js',
...
const outside = fs.mkdtempSync(path.join(os.tmpdir(), 'shipde-ac-32-08-outside-'));
let failures = 0;
try {
  for (const subject of SUBJECTS) {
