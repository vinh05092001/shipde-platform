'use strict';
// AC-AI-09-01 — the invariant: TASK-AI-09's Control table and its
// delivery-register row (row 142) carry the same status. The comparison lives in
// `./lib/spec-status-alignment.js`, the same module the negative proof
// `ac-09-02-status-divergence.js` requires, so the gate and the proof of the
...
console.log(
  'Control status matches register row 142: ' +
