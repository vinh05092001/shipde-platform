'use strict';
// AC-AI-11-02 — negative proof for the Control-table/register comparison.
//
// The check lives in `./lib/spec-status-alignment.js`, the same module the
// invariant `ac-11-01-status-alignment.js` requires: editing the rule changes
...
const tmp = path.join(os.tmpdir(), 'shipde-ac11-02-' + process.pid + '.md');
