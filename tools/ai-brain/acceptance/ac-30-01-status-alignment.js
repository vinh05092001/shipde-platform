'use strict';
// AC-AI-30-01 — the invariant: TASK-AI-30's Control table and its
// delivery-register row (row 163) carry the same status. The comparison lives in
// `./lib/spec-status-alignment.js`, the same module the negative proof
// `ac-30-02-status-divergence.js` requires, so the gate and the proof of the gate
// cannot drift apart.
//
// The row reads the real specification and the real register; there is no fixture.
...
const SPEC = 'docs/product-spec/work-items/TASK-AI-30.md';
...
console.log(
  'Control status matches register row 163: ' +
