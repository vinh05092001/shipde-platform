'use strict';
// AC-AI-21-01 — the invariant: TASK-AI-21's Control table and its
// delivery-register row (row 154, the register's `delivery_order` column) carry
// the same status. The comparison lives in `./lib/spec-status-alignment.js`, the
// same module the negative proof `ac-21-02-status-divergence.js` requires, so the
...
console.log(
  'Control status matches register row 154: ' +
