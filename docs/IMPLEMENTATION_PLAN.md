...
| **CR-5** | Microcopy có còn phô trương hoặc dùng raw enum không? | Cần quét toàn bộ mã nguồn để thay thế từ ngữ kỹ thuật. | **ĐIỀU CHỈNH**: Sử dụng ngôn ngữ tác nghiệp thuần túy: *"Gửi yêu cầu giao lại"*, *"Tạo hồ sơ hỗ trợ tại cổng hãng"*, *"Còn [X] giờ tới hạn xử lý"*. |
