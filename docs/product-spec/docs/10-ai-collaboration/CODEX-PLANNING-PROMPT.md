...
4. Create the Work Item from WORK-ITEM-TEMPLATE.md and fill every business, technical-boundary and acceptance section.
...
8. Check Definition of Ready. Only when every gate passes, update exactly that register row to READY_FOR_AUTHOR.
