...
| `AC-AI-22-06` | **Negative proof, must fail:** a copy of the real seed whose first approved lesson is approved by its own proposer is rejected by the rule `AC-AI-22-05` runs | `node tools/ai-brain/acceptance/ac-22-06-self-approval-detected.js` | `1` | `PROMOTION_CONTRACT_VIOLATED: SELF_APPROVAL: LESSON-ACCEPTANCE-ROW-REAL-FILE approved by its proposer codex-review` | `tools/ai-brain/acceptance/ac-22-06-self-approval-detected.js`; command stderr |
