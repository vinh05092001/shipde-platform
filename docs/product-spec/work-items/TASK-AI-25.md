...
2. **F2 — missing spec-mandated R07 unit test.** `validateEntry returns EVIDENCE_STALE for stale operator-declared removal (R07)` exists at `tools/ai-brain/test/feedback.test.js:176` and passes. `node --test tools/ai-brain/test/feedback.test.js` → 20 pass / 0 fail. `node --test tools/ai-brain/test/*.test.js` → 413 pass / 0 fail across 92 suites.
