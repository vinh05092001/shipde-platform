...
| ------------ | ------ | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1            | `HEAD` | `READY_FOR_CODEX` | Initial implementation of governed exact-HEAD auto-merge satisfying all 25 acceptance criteria AC-AI-13-01 through AC-AI-13-25: (1) Added `Test-ShipDeMergePreflight` single-snapshot validation (exact 40-char SHA, required CI SUCCESS from GitHub Actions, trusted `chatgpt-codex-connector[bot]` exact-head PASS, zero unresolved threads via GraphQL pagination, mergeable status, repository push permission); (2) Added `Invoke-ShipDeAutoMerge` with crash-safe `MERGE_INTENT_PERSISTED` state persistence, single GraphQL `mergePullRequest` squash mutation with `expectedHeadOid`, and remote state reconciliation on timeout; (3) Added PR #8 preservation during bootstrap and prioritized repair after TASK-AI-13 merge; (4) Added `CORE_COMPLETE` boundary termination when both TASK-AI-12 and TASK-AI-13 are MERGED. Ready for fresh independent Codex review. |
