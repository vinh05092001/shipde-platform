...
/**
 * Canonical error payload per docs/product-spec/docs/05-api-integrations/INTERNAL-API.md
 */
...
/**
 * Flexible error payload covering canonical structured errors, string error messages,
 * and legacy/validation field maps across preserved prototype API routes.
 */
export type ApiErrorPayload = string | CanonicalApiError | Record<string, unknown>;
...
export type ApiErrorResponse = CanonicalErrorResponse | LegacyErrorResponse;
